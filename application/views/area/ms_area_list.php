<div class="row" style="margin-bottom: 10px">
        ...
        <th>Action</th>
            ...
            <td><?php echo $area->input_datetime ?></td>
            <td><?php echo $area->input_username ?></td>
            <td><?php echo $area->active ?></td>
            <td style="text-align:center" width="200px">
                <?php  
                echo anchor(site_url('area/update/'.$area->area_code),'Update'); 
                echo ' | '; 
                echo anchor(site_url('area/delete/'.$area->area_code),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                ?>
            </td>
        </tr>
                <?php
